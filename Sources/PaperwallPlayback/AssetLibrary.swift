...
public enum AssetLibrary {
    ...
    public static var wallspaceDirectory: URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Caches/Wallspace/Wallpapers", isDirectory: true)
    }

    public static var paperwallLibraryDirectory: URL {
        PaperwallConfiguration.applicationSupportDirectory
            .appendingPathComponent("Library/Wallspace", isDirectory: true)
    }

    public static func wallspaceVideos() -> [URL] {
        videos(in: wallspaceDirectory)
    }
